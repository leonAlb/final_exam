...
Future<Map<String, Map<String, double>>> calculateBalance(List<Expense> expenses) async {
    ...
    // Every expense builds up either "Credit" or "Debt" for each member in the group (Simplifies balancing)
    ...
    while (i < debtors.length && j < creditors.length) {
        ...
        if (debtorAmount == 0) {
            ...
            debtors[i] = MapEntry(debtorId, -debtorAmount);
        }
        ...
        if (creditorAmount == 0) {
            ...
            creditors[j] = MapEntry(creditorId, creditorAmount);
        }
    }
